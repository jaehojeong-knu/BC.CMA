...
BCA.bb <- function(beta, th, u, x1, x2, COV) {
  ...
  E_D2_bb <- t(matrix(c(
    0, 0, 0, 1, x1, c(rep(0, len_c)), 1, x2, u,
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
  ...
  E_D3_bb <- t(matrix(c(
    0, 0, 0, 1, x2, c(rep(0, len_c)), 1, x2, u,
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
  ...
  E_I3_bb <- t(matrix(c(
    0, 0, 0, 1, x1, c(rep(0, len_c)), 1, x1, u,
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
    0, 0, 0, 0, 0, c(rep(0, len_c)), 0, 0, c(rep(0, len_c)),
  ...
  exp_bbD1_bc1_x1x2 <- exp(h_bb_D1 * (x1 - x2)) * {
    1 - 0.5 * (h_bb_D1_df1 %*% COV %*% t(h_bb_D1_df1)) -
      0.5 * tr(h_bb_D1_df2 %*% COV)
  }^{x1 - x2}
  exp_bbD1_bc2_x1x2 <- exp(h_bb_D1 * (x1 - x2)) * {
    1 + 0.5 * (h_bb_D1_df1 %*% COV %*% t(h_bb_D1_df1)) +
      0.5 * tr(h_bb_D1_df2 %*% COV)
  }^{-(x1 - x2)}
  exp_bbD2_bc1 <- exponential_BC1_fnt(COV, h_bb_D2, h_bb_D2_df1, h_bb_D2_df2)
  exp_bbD2_bc2 <- exponential_BC2_fnt(COV, h_bb_D2, h_bb_D2_df1, h_bb_D2_df2)
  exp_bbD3_bc1 <- exponential_BC1_fnt(COV, h_bb_D3, h_bb_D3_df1, h_bb_D3_df2)
  exp_bbD3_bc2 <- exponential_BC2_fnt(COV, h_bb_D3, h_bb_D3_df1, h_bb_D3_df2)
  ...
  exp_bbI1_bc1 <- exponential_BC1_fnt(COV, h_bb_I1, h_bb_I1_df1, h_bb_I1_df2)
  exp_bbI1_bc2 <- exponential_BC2_fnt(COV, h_bb_I1, h_bb_I1_df1, h_bb_I1_df2)
  exp_bbI2_bc1 <- exponential_BC1_fnt(COV, h_bb_I2, h_bb_I2_df1, h_bb_I2_df2)
  exp_bbI2_bc2 <- exponential_BC2_fnt(COV, h_bb_I2, h_bb_I2_df1, h_bb_I2_df2)
  exp_bbI3_bc1 <- exponential_BC1_fnt(COV, h_bb_I3, h_bb_I3_df1, h_bb_I3_df2)
  exp_bbI3_bc2 <- exponential_BC2_fnt(COV, h_bb_I3, h_bb_I3_df1, h_bb_I3_df2)
